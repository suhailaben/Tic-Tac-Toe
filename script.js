...
function play(element) {
    ...
    if (Menu.opponent === gameBoard.computerPlayer || Menu.opponent === gameBoard.Totoro) {
        computerPlay();
    }
        render();
        updateState();
...
const Menu = (() => {
   ...
   const reset = () => {
    ...
    function rename(whomever) {
        gameBoard[whomever]['name'] = prompt(`What is ${gameBoard[whomever]['name']}'s name?`, 'X')
    }
    ...
    humanButton.addEventListener('click', () => changeOpponent(gameBoard.playerTwo));
    aiButton.addEventListener('click', () => changeOpponent(gameBoard.computerPlayer));
    totoroButton.addEventListener('click', () => changeOpponent(gameBoard.Totoro));
